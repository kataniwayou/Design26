...
public class ManagerHttpClient : IManagerHttpClient
{
    ...
    private async Task<AddressModel?> TryGetAddressEntityAsync(Guid entityId)
    {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (addressEntity != null)
                {
                    ...
                    return new AddressModel
                    {
                        ...
                        Configuration = new Dictionary<string, object>(), // TODO: Add configuration if available
        ...
        {
            _logger.LogDebugWithCorrelation(ex, "Failed to retrieve entity as address. EntityId: {EntityId}", entityId);
            return null;
        }
    }
    ...
    private async Task<DeliveryModel?> TryGetDeliveryEntityAsync(Guid entityId)
    {
        ...
        {
            _logger.LogDebugWithCorrelation(ex, "Failed to retrieve entity as delivery. EntityId: {EntityId}", entityId);
            return null;
        }
    }

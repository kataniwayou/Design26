...
public class AddressController : ControllerBase
{
    ...
    public async Task<ActionResult<AddressEntity>> GetById(string id)
    {
        ...
        _logger.LogInformationWithCorrelation("Starting GetById Address request. Id: {Id}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            if (entity == null)
            {
                _logger.LogWarningWithCorrelation("Address entity not found. Id: {Id}, User: {User}, RequestId: {RequestId}",
                    guidId, userContext, HttpContext.TraceIdentifier);
                return NotFound($"Address entity with ID {guidId} not found");
            }

            _logger.LogInformationWithCorrelation("Successfully retrieved Address entity. Id: {Id}, Version: {Version}, Name: {Name}, ConnectionString: {ConnectionString}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogErrorWithCorrelation(ex, "Error retrieving Address entity by ID. Id: {Id}, User: {User}, RequestId: {RequestId}",
                guidId, userContext, HttpContext.TraceIdentifier);
    ...
    public async Task<ActionResult<AddressEntity>> GetByCompositeKey(string version, string name, string connectionString)
    {
        ...
        _logger.LogInformationWithCorrelation("Starting GetByCompositeKey Address request. Version: {Version}, Name: {Name}, ConnectionString: {ConnectionString}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        try
        {
            ...
            {
                _logger.LogWarningWithCorrelation("Empty or null version/name/connectionString provided. Version: {Version}, Name: {Name}, ConnectionString: {ConnectionString}, User: {User}, RequestId: {RequestId}",
            ...
            if (entity == null)
            {
                _logger.LogWarningWithCorrelation("Address entity not found by composite key. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
        ...
        {
            _logger.LogErrorWithCorrelation(ex, "Error retrieving Address entity by composite key. Version: {Version}, Name: {Name}, CompositeKey: {CompositeKey}, User: {User}, RequestId: {RequestId}",
                version, name, compositeKey, userContext, HttpContext.TraceIdentifier);
            return StatusCode(500, "An error occurred while retrieving the Address entity");
        }
    }
